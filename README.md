...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.292@aar'
```
...
pod "FluentIcons", "1.1.292"
```

#### Carthage

```bash
git "git@github.com:microsoft/fluentui-system-icons.git" "1.1.292"
```
